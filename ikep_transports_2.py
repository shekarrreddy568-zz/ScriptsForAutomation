...
def describe_configs(a, topic):
    ...
    for res, f in fs.items():
        try:
            ...
            print("Failed to describe the topic {} configuration: {}".format(topic, e))
...
def alter_configs(a, topic):
    ...
    for res, f in fs.items():
        try:
            ...
            print("Failed to alter the topic {} configuration: {}".format(topic, e))
